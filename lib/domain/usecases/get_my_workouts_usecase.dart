...
class GetMyWorkoutsUseCase implements UseCase<List<Workout>, NoParams> {
  final WorkoutRepository workoutRepository;

  GetMyWorkoutsUseCase(this.workoutRepository);

  @override
  Future<Either<Failure, List<Workout>>> call(NoParams params) async {
    return await workoutRepository.getMyWorkouts();
  }
}
